...
function modal() {
  ...
  if (params['count']) {
    ...
    img.src = "/public/assets/images/".concat(params['image']);
    var countEl = document.createElement('div');
    countEl.classList.add('spin-modal__count');
    countEl.innerHTML = "<span>x".concat(params['count'], "</span>");
    modalEl.querySelector('.spin-modal__img').append(countEl);
    modalEl.querySelector('.spin-modal__img').append(img);
    modalEl.querySelector('.spin-modal__text').innerText = "You got ".concat(params['count'], " ").concat(params['description']);
  } else {
...
/* harmony import */ var core_js_modules_es_symbol_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.js */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol_description_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/es.symbol.description.js */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var _modules_services_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/services.js */ "./src/js/modules/services.js");
...
document.addEventListener("DOMContentLoaded", function () {
  var wheelIsRotating = false,
      // состояние колеса (крутится ли оно в данный момент)
  duration = 360 * 5,
      // количество вращений колеса
  rotateStart = null,
      // начало анимации вращения (для FequestAnimationFrame)
  ...
  document.getElementById('rotate').addEventListener('click', function () {
    ...
    (0,_modules_services_js__WEBPACK_IMPORTED_MODULE_3__.getItem)().then(function (item) {
      if (!item) {
        (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_4__["default"])({});
      }

      var randomItem = item['item'];
      var randomSpace = getRandomNumber(randomItem * spaceItem - spaceItem, randomItem * spaceItem - 10) - 35;
      ...
      requestAnimationFrame(function mesure(time) {
        ...
        var progress = time - rotateStart;
        wheel.style.transform = "rotate(-".concat(progress, "deg)");
